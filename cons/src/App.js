    ...
    return (
        <div className="App">
            ...
            {state && <div className='contacts'>
                ...
                <div className='telegram'><img className='img-before' src={telegram} alt=""/>Telegram: @Remelancec</div>
                <div className='phone'><img className='img-before' src={phone} alt=""/>Телефон: +7 (901) 758-28-04</div>
